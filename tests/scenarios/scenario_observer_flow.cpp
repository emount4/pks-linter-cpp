...
/**
 * Демонстрирует работу паттерна Observer: анализатор уведомляет 
 * о начале/конце каждого файла и о каждом найденном нарушении.
 * ConsoleObserver выводит все события в консоль.
 */
